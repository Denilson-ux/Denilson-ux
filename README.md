<h1 align="center">Hola , soy Denilson/unsimpledev <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
...
- :school: Soy estudiante de la Universidad Gabriel Rene Moreno-Finor de la carrera Ing. Sistemas
- :trophy: 2x
- :technologist: 💻 Me encanta usar el software como una solución para cada .Problem
💻 Soy un programador competitivo
- :computer: 🎓 Actualmente estoy aprendiendo y .Computer ScienceSoftware Engineering
- :nerd_face: Siempre.learning new things
- :thinking: Actualmente estoy abierto para un nuevo, este es MI CURRÍCULUM.job opportunity
